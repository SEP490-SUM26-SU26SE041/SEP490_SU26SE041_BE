...
public partial class SmartFarmDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AitaskAssignmentSuggestion>(entity =>
        {
            ...
            entity.Property(e => e.ReviewStatus).HasColumnType("public.\"AIReviewStatus\"");
        ...
        modelBuilder.Entity<Alert>(entity =>
        {
            ...
            entity.Property(e => e.Severity).HasColumnType("public.\"AlertSeverity\"");
        ...
        modelBuilder.Entity<Area>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasColumnType("public.\"LocationStatus\"");
        ...
        modelBuilder.Entity<CareSchedule>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnType("timestamp without time zone");
            entity.Property(e => e.TaskType).HasColumnType("public.\"TaskType\"");
            entity.Property(e => e.Title).HasMaxLength(150);
        ...
        modelBuilder.Entity<Experiment>(entity =>
        {
            ...
            entity.Property(e => e.Status)
                .HasColumnType("public.\"ExperimentStatus\"")
        ...
        modelBuilder.Entity<ExperimentBedAssignment>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("gen_random_uuid()");
            entity.Property(e => e.Status).HasColumnType("public.\"AllocationStatus\"");
        ...
        modelBuilder.Entity<ExperimentDesign>(entity =>
        {
            ...
            entity.Property(e => e.DesignType).HasColumnType("public.\"DesignType\"");
        ...
        modelBuilder.Entity<ExperimentGroup>(entity =>
        {
            ...
            entity.Property(e => e.GroupType).HasColumnType("public.\"GroupType\"");
        ...
        modelBuilder.Entity<ExperimentRequest>(entity =>
        {
            ...
            entity.Property(e => e.Status)
                .HasColumnType("public.\"RequestStatus\"")
        ...
        modelBuilder.Entity<ExperimentStage>(entity =>
        {
            ...
            entity.Property(e => e.StageType).HasColumnType("public.\"ExperimentStageType\"");
            entity.Property(e => e.UpdatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnType("timestamp without time zone");
        ...
        modelBuilder.Entity<KnowledgeDocument>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnType("timestamp without time zone");
            entity.Property(e => e.Status).HasColumnType("public.\"DocumentStatus\"");
            entity.Property(e => e.Title).HasMaxLength(200);
        ...
        modelBuilder.Entity<RequestReview>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("gen_random_uuid()");
            entity.Property(e => e.Result).HasColumnType("public.\"ReviewResult\"");
        ...
        modelBuilder.Entity<Task>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasColumnName("Status").HasColumnType("public.\"TaskStatus\"");
            entity.Property(e => e.Title).HasMaxLength(150);
            entity.Property(e => e.Type).HasColumnName("TaskType").HasColumnType("public.\"TaskType\"");
            entity.Property(e => e.UpdatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnType("timestamp without time zone");
        ...
        modelBuilder.Entity<TaskAssignment>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasColumnType("public.\"TaskAssignmentStatus\"");
